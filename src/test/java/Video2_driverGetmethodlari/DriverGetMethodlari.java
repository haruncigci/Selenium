...
public class DriverGetMethodlari {
    public static void main(String[] args) {
        ...
        System.out.println("==============================================================");
        System.out.println(driver.getPageSource()); // arka planda calisan
        System.out.println("===============================================================");

        // 5 - driver.getWindowHandle () --> icinde oldugu sayfanin UNIQE hash kodunu döndürür
        System.out.println(driver.getWindowHandle()); // CDWindow - F4A....

        // 6  - driver.getWindowhandles() --> driver calisirken acilan tüm sayfalarin UNIQE hash kodunu döndürür
    }
}

...
public class WebElements02 {
    public static void main(String[] args) {
        ...
        epostaKutusu.sendKeys("asdfghjklö");

        // sifre kismina rastgele bir sifre girin
        WebElement passKutusu= driver.findElement(By.xpath("//input[@id='pass']"));
        passKutusu.sendKeys("lvfkanbgöosnfgi");
        // giris yap butonuna basin
        driver.findElement(By.xpath("//button[@name='login']")).click();
        // uyari olarak "The email or mobile number you entered isn't connected to an account. Find your account and login in."
